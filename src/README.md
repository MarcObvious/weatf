...
the header and footer. It declares with `ngApp` that this is `weatf`,
...
weatf insert 3 views in index.html: 
...
"weatf" will rename the resultant CSS and JavaScript placed in `build/`,
